...
uint32_t Fre_Wake[5] = {471800000, 492570000, 509770000, 868000000, 915000000};
uint32_t Fre_Read[5] = {490200000, 492570000, 509770000, 868000000, 915000000};
...
int main(void)
{
    ...
    //配置各个参数
    G_LoRaConfig.LoRa_Freq = Fre_Wake[0];      //中心频率470MHz
