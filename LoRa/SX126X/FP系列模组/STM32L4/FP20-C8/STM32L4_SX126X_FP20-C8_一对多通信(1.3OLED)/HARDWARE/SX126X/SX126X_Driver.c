...
#include "timer.h"
#define VERSION        L_LRMFP20_77NN4     //选择所选用产品型号，例如： LSD4RF_2R717N40
                                                                 //     LSD4RF_2R717N30
																																 //     LSD4RF_2R722N20      
																																 //     LSD4RF_2R714N10 
...
void SetRxTxFallbackMode(RadioSetRxTxFallbackMode_t Fallback_Mode)
{
	SX126xWriteCommand( RADIO_SET_TXFALLBACKMODE, ( uint8_t* )&Fallback_Mode, 1 );
}
...
{
    if((frequency > 920000000) || (frequency < 410000000))
...
void SX126X_WOR_Exit(void)
{
    ...
    SX126xSetBufferBaseAddress( 0x00, 0x00 );
    SX126xSetRx( 0x000000 ); // Rx single
}
