...
{
    if((frequency > 930000000) || (frequency < 410000000))
...
{
if((G_LoRaConfig.LoRa_Freq < 410000000) || (G_LoRaConfig.LoRa_Freq > 930000000))
        return false;
...
//	 if (VERSION==LSD4RF_2R717N40 || VERSION==LSD4RF_2R822N30)
